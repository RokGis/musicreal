...
class _MusicSearchSheetWidgetState extends State<MusicSearchSheetWidget> {
  ...
  void initState() {
    ...
    _model.searchInputFocusNode!.addListener(() => safeSetState(() {}));
  }
                    ...
                    Container(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          _model.soundPlayer!
                              .setUrl(listViewMusicRecord.songURL)
